    ...
    public function checkPluBarcode(Request $request) {
        ...
        switch ($data['mstd_unit']) {
            case 'CTN':
                ...
                $totalPriceBarcode = ($mstd_ctn * $priceCtnBarcode) + ($mstd_ctn * $mstd_pcs * $pricePcsBarcode);
                break;            
            case 'BOX':
                $mstd_ctn = 0;
            ...
            case 'PCS':
                ...
                $totalPriceBarcode = ($mstd_pcs * $pricePcsBarcode);
                break;
        }
