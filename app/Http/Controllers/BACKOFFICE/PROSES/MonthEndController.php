...
//        $sql = "BEGIN SP_HITUNG_STOCK2('" . Session::get('kdigr') . "'," . $p_awal . "," . $p_akhir . ",' ','ZZZZZZZ',:p_sukses,:err_txt); END;";
//        $s = oci_parse($c, $sql);
//
...
//        }
//
//        $sql = "BEGIN SP_HITUNG_STOCKCMO2('" . Session::get('kdigr') . "'," . $p_awal . "," . $p_akhir . ",:p_sukses,:err_txt); END;";
//        $s = oci_parse($c, $sql);
//
...
////    ----->>>> Hitung Sales Rekap <<<<-----
////    SYNCHRONIZE;
//        $sql = "BEGIN SP_HITUNG_SLREKAP2('" . Session::get('kdigr') . "'," . $p_awal . "," . $p_akhir . ",'" . Session::get('usid') . "',:p_sukses,:err_txt); END;";
//        $s = oci_parse($c, $sql);
//
//        oci_bind_by_name($s, ':p_sukses', $p_sukses, 200);
//        oci_bind_by_name($s, ':err_txt', $err_txt, 200);
...
//        }
////   ----->>>> Proses LPP <<<<-----
//        $sql = "BEGIN SP_PROSES_LPP2('" . Session::get('kdigr') . "'," . $p_awal . "," . $p_akhir . ",true,:p_sukses,:err_txt); END;";
//        $s = oci_parse($c, $sql);
//
//        oci_bind_by_name($s, ':p_sukses', $p_sukses, 200);
//        oci_bind_by_name($s, ':err_txt', $err_txt, 200);
...
//        DB::connection(Session::get('connection'))->select("delete from tbtr_backoffice where trbo_kodeigr='" . Session::get('kdigr') . "' and nvl(trbo_recordid,' ')='2' and nvl(trbo_nonota,' ')<>' '");
//        $p_progress = $p_progress + 1;
//        loop_progress_bar('BL_INPUT.PROGRESSBAR', (p_progress / p_loop) * 419);
//
//
...
////    SYNCHRONIZE;
//        $sql = "BEGIN SP_COPY_STOCK2('" . Session::get('kdigr') . "','" . $txt_tahun . $txt_bulan . "',:p_sukses,:err_txt); END;";
//        $s = oci_parse($c, $sql);
//
//        oci_bind_by_name($s, ':p_sukses', $p_sukses, 200);
//        oci_bind_by_name($s, ':err_txt', $err_txt, 200);
//        oci_execute($s);
//
//        $sql = "BEGIN sp_copy_stock_CMO2('" . Session::get('kdigr') . "','" . $txt_tahun . $txt_bulan . "',:p_sukses,:err_txt); END;";
//        $s = oci_parse($c, $sql);
//
//        oci_bind_by_name($s, ':p_sukses', $p_sukses, 200);
//        oci_bind_by_name($s, ':err_txt', $err_txt, 200);
...
//        }
//
//        $sql = "BEGIN sp_lpp_point('" . $txt_tahun . $txt_bulan . "','" . Session::get('usid') . "'||'Y',:err_txt); END;";
//        $s = oci_parse($c, $sql);
//
//        oci_bind_by_name($s, ':err_txt', $err_txt, 200);
//        oci_execute($s);
