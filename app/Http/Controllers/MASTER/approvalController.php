...
//        $result = DB::connection($_SESSION['connection'])->table('TBMASTER_REPORT_APPROVAL')->SELECT("*")->First();
        return view('MASTER.approval');
    }

    public function saveData(Request $request){
//        $result = DB::connection($_SESSION['connection'])->table('TBMASTER_REPORT_APPROVAL')->SELECT("*")->count();
//        if ($result==0) {
            DB::connection($_SESSION['connection'])->table('TBMASTER_REPORT_APPROVAL')->insert(
...
//        }
//        else{
//            DB::connection($_SESSION['connection'])->table('TBMASTER_REPORT_APPROVAL')->where('RAP_KODEIGR','22')
