...
class uniquecodeController extends Controller
{
    ...
    public function getCashBack(){
        $datas = DB::connection(Session::get('connection'))->table('tbtr_cashback_hdr')
    ...
    public function getGift(){
        $datas = DB::connection(Session::get('connection'))->table('tbtr_gift_hdr')
...
//            ->get()->toArray();
        ...
        $datas = DB::connection(Session::get('connection'))->select("SELECT PRD_PRDCD, PRD_DESKRIPSIPENDEK
    ...
    public function cetak(Request $request){
        ...
        if($jenisMember == 'khusus'){
            ...
            if($jenisPromosi == 'cashback'){
                $memb_unique = DB::connection(Session::get('connection'))->select("SELECT NVL (COUNT (1), 0) as result
        ...
        $kunj = DB::connection(Session::get('connection'))->select("SELECT TOTALK
