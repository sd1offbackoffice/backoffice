...
class ampController extends Controller
{
    ...
    public function index()
    {
        ...
        $datas = DB::connection(Session::get('connection'))->table('TBTR_SEGMENTASI_CUS')
            ->selectRaw("*")
        ...
        for($i=0;$i<sizeof($datas);$i++){
            ...
            $nama_seg[$i] = DB::connection(Session::get('connection'))->table("tbmaster_segmentasi")
                ->selectRaw('seg_nama')
                ->where('seg_id','=',$temp)
                ->first();
        }
    ...
    public function GetData()
    {
        ...
        for($i=0;$i<sizeof($datas);$i++){
            $member[$i] = DB::connection(Session::get('connection'))->table('tbmaster_customer')
    ...
    public function UpdateData(Request $request){
        try{
            ...
            DB::connection(Session::get('connection'))->table("TBTR_SEGMENTASI_CUS")
            ...
            DB::connection(Session::get('connection'))->table("TBMASTER_CUSTOMERCRM")
