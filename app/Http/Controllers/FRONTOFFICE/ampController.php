...
class ampController extends Controller
{
    ...
    public function index()
    {
        ...
        $segmentasi = DB::table('tbmaster_segmentasi')
            ->selectRaw("seg_id")
            ->selectRaw("seg_nama")
        ...
        $datas = DB::table('TBTR_SEGMENTASI_CUS')
            ->selectRaw("*")
        ...
        for($i=0;$i<sizeof($datas);$i++){
            ...
            $nama_seg[$i] = DB::table("tbmaster_segmentasi")
                ->selectRaw('seg_nama')
                ->where('seg_id','=',$temp)
                ->first();
        }
    ...
    public function GetData()
    {
        ...
        for($i=0;$i<sizeof($datas);$i++){
            $member[$i] = DB::table('tbmaster_customer')
