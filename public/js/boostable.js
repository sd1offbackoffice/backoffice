...
var newColHtml = '<button id="bElim" type="button" class="btn btn-sm btn-default"  onclick="rowElim(this);">' +
...
var saveColHtml = '<button id="bElim" type="button" class="btn btn-sm btn-default"  onclick="rowElim(this);">' +
    '<i class="fas fa-trash" aria-hidden="true"></i>' +
    '</button>' +
    '<button id="" type="button" class="btn btn-sm btn-default">' +
    '<i class="fas fa-bell" aria-hidden="true"></i>' +
...
$.fn.SetEditable = function (options) {
    ...
    // this.find('thead tr').before('<th name="buttons">Actions</th>'); //encabezado vacío
    // this.find('thead tr').append('<th name="buttons">Actions</th>'); //encabezado vacío????
    // this.find('tbody tr').before(colEdicHtml);
    ...
    if ($filas.length == 0) {
        ...
        $cols.each(function () {
            if ($(this).attr('name') == 'buttons') {
                ...
                htmlDat = colEdicHtml + htmlDat; //agrega botones
