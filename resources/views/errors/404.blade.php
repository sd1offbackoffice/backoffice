...
<div class="error">
    ...
    <a href="{{ url('/') }}"><button class="error__button" style="background-color: #007bff; color: white">BACK TO HOME</button></a>
{{--    <button class="error__button error__button--active">BACK TO HOME</button>--}}
