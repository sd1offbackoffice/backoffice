...
@section('title','TABEL | PLU NON REFUND')
                ...
                <fieldset class="card border-secondary">
                    <div class="card-body pt-0">
                        <fieldset class="card border-secondary mt-0">
                            <legend  class="w-auto ml-3">Tabel PLU Yang Tidak Bisa Refund [ Add by PLU ]</legend>
                        ...
                        <fieldset class="card border-secondary mt-0">
                            <legend  class="w-auto ml-3">Tabel PLU Yang Tidak Bisa Refund [ Add by Divisi, Departement, Kategori ]</legend>
                            <div class="card-body py-0">
                                <div class="row form-group">
