    ...
    <div class="container">
        <div class="row">
            <nav class="navbar navbar-light navbar-expand-lg mainmenu">
                <a class="navbar-brand" href="{{url("/")}}"> <img src="{{asset('image/Indogrosir_logo.jpg')}}" width="100px"></a>
                    ...
                    <ul class="navbar-nav mr-auto">
                        @if($_SESSION['usid'] != 'LAW')
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            ...
                                            <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                                    ...
                                                    <li><a href="{{url("/bo/transaksi/penerimaan/cetakbpb/index")}}">Cetak Laporan BPB</a></li>
                                                </ul>
                                            </li>
                                            <li class="dropdown">
                                                <a class="dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            ...
                                            <li><a href="{{url("/laporan/outsscan/index")}}">Laporan Outstanding Scanning IDM / OMI</a></li>
                                            <li><a href="{{url("/laporan/kunjunganbkl/index")}}">Laporan Bulanan Kedatangan Supplier BKL</a></li>
                                            <li><a href="{{url("/laporan/saleshbv/index")}}">Laporan Transfer Satuan Produk Hot Beverages</a></li>
                                            <li><a href="{{url("/laporan/servicelevelitempareto/index")}}">Laporan Service Level Item Pareto</a></li>
                                        </ul>
                                    </li>
                                    <li class="dropdown">
                                        <a class="dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            <li><a href="{{url("/kerjasamaigridm/lapbedatag/index")}}">Laporan Perbedaan Tag</a></li>
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            ...
                                            <li><a href="{{url("/btas/monitoring/peritem/index")}}">Per Item Barang</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li><a href="{{url("/frontoffice/promosihokecab/index")}}">Download Data Promosi HO</a></li>
                                    <li class="dropdown">
                                        <a class="dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                           data-toggle="dropdown" aria-haspopup="true"
                                           aria-expanded="false">Laporan Kasir</a>
                                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            <li><a href="{{url("/frontoffice/laporankasir/csi/index")}}">Laporan Cashback / Supplier / Item</a></li>
                                            <li><a href="{{url("/frontoffice/laporankasir/cei/index")}}">Laporan Cashback / Event / Item</a></li>
                                        </ul>
                                    </li>
