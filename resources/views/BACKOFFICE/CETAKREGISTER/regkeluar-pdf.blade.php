    ...
    <table class="table">
        ...
        <tfoot>
            <tr>
                ...
                <td class="border-top right">{{ number_format(round($pkp->ppn_bebas), 0, '.', ',') }}</td>
                <td class="border-top right">{{ number_format(round($pkp->ppn_dtp), 0, '.', ',') }}</td>                                
            ...
            <tr>
                ...
                <td class="right">{{ number_format(round($npkp->ppn_bebas), 0, '.', ',') }}</td>
                <td class="right">{{ number_format(round($npkp->ppn_dtp), 0, '.', ',') }}</td>                                
            ...
            <tr>
                ...
                <td class="right">{{ number_format(round($pembelian->ppn_bebas), 0, '.', ',') }}</td>
                <td class="right">{{ number_format(round($pembelian->ppn_dtp), 0, '.', ',') }}</td>                                
            ...
            <tr>
                ...
                <td class="right">{{ number_format(round($lain->ppn_bebas), 0, '.', ',') }}</td>
                <td class="right">{{ number_format(round($lain->ppn_dtp), 0, '.', ',') }}</td>                                
            ...
            <tr>
                ...
                <td class="right">{{ number_format(round($total->ppn_bebas), 0, '.', ',') }}</td>
                <td class="right">{{ number_format(round($total->ppn_dtp), 0, '.', ',') }}</td>                                
