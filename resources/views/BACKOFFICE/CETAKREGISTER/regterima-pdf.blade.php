...
<html>
<head>
    <title>Register Bukti Penerimaan Barang</title>
</head>
<body>
...
<header>
    ...
    <h2 style="text-align: center">** REGISTER BUKTI PENERIMAAN BARANG **<br>{{ $tgl1 }} - {{ $tgl2 }}</h2>
</header>
    ...
    <table class="table">
        ...
        @foreach($data as $d)
            @if($temp != $d->msth_tgldoc)
                @if($temp != '')
                <tr>
                    <td class="border-top left" colspan="6">SUBTOTAL TANGGAL</td>
