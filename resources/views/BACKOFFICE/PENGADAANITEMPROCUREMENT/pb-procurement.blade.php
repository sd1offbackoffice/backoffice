                        ...
                        <div class="row form-group">
                            ...
                            <div class=" offset-1 col-sm-3">
                                <button type="button" id="btn-save"
                                        ...
                                        onclick="saveData()" disabled> UPLOAD PB
                                </button>
                            </div>
                    ...
                    if (response.status == 'error') {
                        ...
                        for (i = 0; i < response['pbd'].length; i++) {
                            $('#tbody-detail').append(
                                ...
                                "    <td class='p-0'>\n" +
                                "        <input disabled class='form-control form-control-sm text-right persendisc1' value='" + (response["pbd"][i].pbd_pkmt) + "'>\n" +
                                "    </td>\n" +

                                "    <td class='p-0'>\n" +
                                "        <input disabled class='form-control form-control-sm text-right' value='" + (response["pbd"][i].minor) + "'>\n" +
                                "    </td>\n" +

                                "    <td class='p-0'>\n" +
                                "        <input class='form-control form-control-sm text-right stock-pcs' value='" + response["pbd"][i].qtypcs + "' onkeypress='cek_pcs(\"" + i + "\",  event)' " + readonly + ">\n" +
                                "    </td>\n" +

                                "    <td class='p-0'>\n" +
                                "        <input disabled class='form-control form-control-sm text-right pb-out' value='" + (response["pbd"][i].pbd_pbout) + "'>\n" +
                                "    </td>\n" +
