...
{{--                    <legend  class="w-auto ml-3">Cetak Penyesuaian</legend>--}}
                    <div class="card-body pb-0">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-2">
                                <input maxlength="10" type="text" class="form-control tanggal" id="tanggal1" onchange="getData()" autocomplete="off">
                            </div>
                            <label class="pt-1">s/d</label>
                            <div class="col-sm-2">
                                <input maxlength="10" type="text" class="form-control tanggal" id="tanggal2" onchange="getData()" autocomplete="off">
                            </div>
    ...
    <script>
        var listNomor = [];
        var selected = [];
        var updateLokasi = false;
        var updatePkmt = false;
        ...
        function checkUpdateLokasi(){
            $.ajax({
                url: '{{ url()->current() }}/check-update-lokasi',
                type: 'POST',
                headers: {
                    'X-CSRF-TOKEN': '{{ csrf_token() }}'
                },
