...
<script>
    ...
    function changeHargaBeli(hrgBeli, qty, qtyk) {
        ...
        ajaxSetup();
        $.ajax({
            url: 'http://172.20.28.17/BackOffice/public/bo/transaksi/penerimaan/input/changehargabeli',
            type: 'post',
            data: {
    ...
    function changeQty(qty, qtyk, hrgbeli, next) {
        ...
        if (!btb_number.val() && !supplier_code.val() && qty != 0) {
            ...
            ajaxSetup();
            $.ajax({
                url: 'http://172.20.28.17/BackOffice/public/bo/transaksi/penerimaan/input/changeqty',
                type: 'post',
                data: {
                    hargaBeli: hrgbeli,
                    prdcd: i_plu.val(),
    ...
    function changeBonus1(bonus1) {
        ...
        ajaxSetup();
        $.ajax({
            url: 'http://172.20.28.17/BackOffice/public/bo/transaksi/penerimaan/input/changebonus1',
            type: 'post',
            data: {
                bonus1: bonus1,
                prdcd: i_plu.val(),
    ...
    function changeRphDisc(next) {
        ajaxSetup();
        $.ajax({
            url: 'http://172.20.28.17/BackOffice/public/bo/transaksi/penerimaan/input/changerphdisc',
            type: 'post',
            data: {
                prdcd: i_plu.val(),
                supplier: supplier_code.val(),
    ...
    function transferPO() {
        if (tempDataSave == '' || tempDataSave == null) {
            ...
            ajaxSetup();
            $.ajax({
                url: 'http://172.20.28.17/BackOffice/public/bo/transaksi/penerimaan/input/transferpo',
                type: 'post',
                data: {
                    noPo: po_number.val(),
                    supplier: supplier_code.val(),
    ...
    function saveData() {
        if (tempDataSave == '' || tempDataSave == null) {
            ...
            ajaxSetup();
            $.ajax({
                url: 'http://172.20.28.17/BackOffice/public/bo/transaksi/penerimaan/input/savedata',
                type: 'post',
                data: {
                    noBTB: btb_number.val(),
                    tglBTB: btb_date.val(),
    ...
    supplier_code.keypress(function(e) {
        if (e.which === 13) {
            ...
            if (typeTrn == 'B') {
                ...
                ajaxSetup();
                $.ajax({
                    url: 'http://172.20.28.17/BackOffice/public/bo/transaksi/penerimaan/input/check-kode-supplier',
                    type: 'post',
                    data: {
                        kodeSupplier
                    },
