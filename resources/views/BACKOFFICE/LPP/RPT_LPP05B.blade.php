    ...
    <table class="table table-bordered table-responsive">
        ...
        @for($i=0;$i<count($data);$i++)
            ...
            @php
                ...
                $total_repackrph     += $data[$i]->lpp_rphprepacking;
            ...
            @if( isset($data[$i+1]->lpp_kodedepartemen) && $tempdep != $data[$i+1]->lpp_kodedepartemen.$data[$i+1]->lpp_kategoribrg || !(isset($data[$i+1]->lpp_kodedepartemen)) )
                ...
                <tr>
                    ...
                    <td align="right">{{ number_format($st_servsup    ,0) }}</td>
                </tr>
                <tr style="border-bottom: 1px solid black;">
                    ...
                    <td align="right">{{ number_format($st_selsorph ,0) }}</td>
        ...
        <tr>
            ...
            <td align="right">{{ number_format($total_akhirqty    ,0) }}</td>
            <td align="right">{{ number_format($total_servsup    ,0) }}</td>
        </tr>
        <tr>
            <td class="left">Rp.</td>
            ...
            <td align="right">{{ number_format($total_selsorph ,0) }}</td>
            ...
            <td align="right">{{ number_format($total_koreksirph    ,0) }}</td>
