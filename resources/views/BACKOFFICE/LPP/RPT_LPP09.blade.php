    ...
    <table class="table table-bordered table-responsive">
        ...
        @for($i=0;$i<count($datas);$i++)
            ...
            @php
                ...
                $st_selso_rph   += $datas[$i]->rph_sel_so;
                ...
                $total_selso_rph   += $datas[$i]->rph_sel_so;
            ...
            @if( isset($datas[$i+1]->lrt_kodedepartemen) && $tempdep != $datas[$i+1]->lrt_kodedepartemen || !(isset($datas[$i+1]->lrt_kodedepartemen)) )
                ...
                <tr style="border-bottom: 1px solid black;">
                    ...
                    <td align="right">{{ number_format($st_selso_rph  ,2) }}</td>
        ...
        <tr>
            ...
            <td align="right">{{ number_format($total_selso_rph  ,2) }}</td>
