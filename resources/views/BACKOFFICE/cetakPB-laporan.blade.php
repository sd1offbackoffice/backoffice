    ...
    <main>
        ...
        <table class="table table-bordered table-responsive" style="">
            ...
            <tr style="text-align: center;">
                ...
                <th rowspan="2" style="width: 30px">SATUAN</th>
                <th rowspan="2" style="width: 30px">TAG</th>
            ...
            @for($i=0; $i<sizeof($datas); $i++)
                ...
                @else
                    <tr style="text-align: right; font-weight: bold">
                        <td colspan="13" style="text-align: right">Total Kategori :</td>
                        <td>200.000</td>
                    </tr>
                    <tr style="text-align: right; font-weight: bold">
                        <td colspan="13" style="text-align: right">Total Departement :</td>
                        <td>300.000</td>
                    </tr>
                @endif
            @endfor
            ...
            {{--@for($i=0; $i<30; $i++)--}}
                ...
                {{--@if($i == 10 || $i == 20)--}}
                    {{--<tr>--}}
                        {{--<td colspan="13" style="text-align: left">Total Kategori</td>--}}
                        {{--<td style="text-align: right"> 13254100</td>--}}
                    {{--</tr>--}}
                    {{--<tr>--}}
                        {{--<td colspan="12"> </td>--}}
                    {{--</tr>--}}
            ...
            {{--</tr>--}}
            {{--<tr>--}}
                {{--<td colspan="13" style="text-align: left">Total Departemen</td>--}}
                {{--<td style="text-align: right"> 234564</td>--}}
            {{--</tr>--}}
            {{--<tr>--}}
                {{--<td colspan="13" style="text-align: left">Total Supplier</td>--}}
                {{--<td style="text-align: right"> 234564</td>--}}
            {{--</tr>--}}
