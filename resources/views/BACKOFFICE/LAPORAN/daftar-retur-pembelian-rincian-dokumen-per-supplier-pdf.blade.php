...
<html>
<head>
    <title>Daftar Retur Pembelian Rincian Dokumen Per Supplier</title>
</head>
<body>
...
<header>
    ...
    <h2 style="text-align: center">** DAFTAR RETUR PEMBELIAN **<br>RINCIAN DOKUMEN PER SUPPLIER</h2>
</header>
...
<main>
    ...
    <table class="table">
        ...
        <tr style="border:1px solid black;">
            <th colspan="2">------- NPB -------</th>
            <th colspan="2" style="vertical-align: middle;">---- NOTA RETUR ----</th>
            ...
            <th rowspan="2" style="vertical-align: middle;">TOT. NILAI AVERAGE</th>
        </tr>
        <tr>
            <th>NOMOR</th>
            <th>TANGGAL</th>
        ...
        @for($i=0;$i<count($data);$i++)
            ...
            <tr>
                ...
                <td class="left">{{ substr($data[$i]->msth_tgldoc,0,10) }}</td>
                <td class="right">{{ $data[$i]->noretur }}</td>
                <td class="right">{{ substr($data[$i]->tglretur,0,10) }}</td>
            ...
            @if((isset($data[$i+1]->supplier) && $tempsup != $data[$i+1]->supplier) || !(isset($data[$i+1]->supplier)) )
                <tr style="border-bottom: 1px solid black;font-style: italic">
                    ...
                    <td class="left" colspan="3">{{ $data[$i]->supplier }} </td>
                    ...
                    <td class="right">{{ number_format($st_sup_avg,2) }}</td>
                </tr>
                @php
                    $st_sup_gross = 0;
                    $st_sup_potongan = 0;
        ...
        <tfoot>
        <tr>
            <td class="left" colspan="4"><strong>TOTAL BKP</strong></td>
        ...
        <tr>
            <td class="left" colspan="4"><strong>TOTAL BTKP</strong></td>
        ...
        <tr>
            <td class="left" colspan="4"><strong>TOTAL SELURUHNYA</strong></td>
