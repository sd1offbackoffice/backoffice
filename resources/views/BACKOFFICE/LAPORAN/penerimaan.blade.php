...
@section('title','LAPORAN | PENERIMAAN ANTAR CABANG')
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <select class="form-control" id="tipe">
                                        <option value="1">1. LAPORAN PENERIMAAN ANTAR CABANG RINGKASAN DIVISI/DEPT/KATEGORI</option>
                                        <option value="2">2. DAFTAR PENERIMAAN ANTAR CABANG RINCIAN PRODUK PER DIVISI/DEPT/KATEGORI</option>
                                    </select>
                                </div>
                            </div>
                            <hr>
