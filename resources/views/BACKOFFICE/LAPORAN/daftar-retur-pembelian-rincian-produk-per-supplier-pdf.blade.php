...
<html>
<head>
    <title>Daftar Retur Pembelian Rincian Produk Per Supplier</title>
</head>
<body>
...
<header>
    ...
    <h2 style="text-align: center">** DAFTAR RETUR PEMBELIAN **<br>RINCIAN PRODUK PER SUPPLIER</h2>
</header>
    ...
    <table class="table">
        ...
        @for($i=0;$i<count($data);$i++)
            ...
            <tr>
                ...
                <td class="right">{{ $data[$i]->mstd_hrgsatuan }}</td>
