...
@section('title','LAPORAN | PENYESUAIAN PERSEDIAAN')
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <select class="form-control" id="tipe">
                                        <option value="1">1. LAPORAN PENYESUAIAN PERSEDIAAN RINGKASAN DIVISI/DEPT/KATEGORI</option>
                                        <option value="2">2. DAFTAR PENYESUAIAN PERSEDIAAN RINCIAN PRODUK PER DIVISI/DEPT/KATEGORI</option>
                                    </select>
                                </div>
                            </div>
                            <hr>
