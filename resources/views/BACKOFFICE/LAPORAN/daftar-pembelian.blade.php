                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <select class="form-control" id="tipe">
                                        <option value="1">1. DAFTAR PEMBELIAN RINGKASAN DIVISI/DEPARTEMEN/KATEGORI
                                        </option>
                                        <option value="2">2. DAFTAR PEMBELIAN RINGKASAN PER SUPPLIER
                                        </option>
                                        <option value="3">3. DAFTAR PEMBELIAN RINCIAN PRODUK PER
                                            DIVISI/DEPARTEMEN/KATEGORI
                                        </option>
                                        <option value="4">4. DAFTAR PEMBELIAN RINCIAN PRODUK PER SUPPLIER
                                        </option>
                                        <option value="5">5. DAFTAR PENERIMAAN PRODUK DIVISI/DEPARTEMEN/KATEGORI
                                        </option>
                                        <option value="6">6. DAFTAR PEMBELIAN RINCIAN PRODUK PER SUPPLIER/DOKUMEN
                                        </option>
                                        <option value="7">7. DAFTAR PEMBELIAN RINCIAN DOKUMEN PERSUPPLIER
                                        </option>
                                    </select>
                                </div>
                            </div>
