...
<html>
<head>
    <title>Daftar Retur Pembelian Rincian Produk Per Divisi / Departemen / Kategori</title>
</head>
<body>
...
<header>
    ...
    <h2 style="text-align: center">** DAFTAR RETUR PEMBELIAN **<br>RINCIAN PRODUK PER DIVISI / DEPARTEMEN / KATEGORI</h2>
</header>
        ...
        @for($i=0;$i<count($data);$i++)
            ...
            @if( isset($data[$i+1]->mstd_kodedepartement) && $tempdep != $data[$i+1]->mstd_kodedepartement || !(isset($data[$i+1]->mstd_kodedepartement)) )
                <tr style="border-bottom: 1px solid black;font-style: italic">
                    ...
                    <td class="right" colspan="3"></td>
                    <td class="right">{{ number_format($st_dep_avg,2) }}</td>
                </tr>
                @php
                    $st_dep_gross = 0;
                    $st_dep_potongan = 0;
