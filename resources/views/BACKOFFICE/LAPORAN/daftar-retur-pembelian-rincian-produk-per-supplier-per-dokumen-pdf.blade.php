...
<html>
<head>
    <title>Daftar Retur Pembelian Rincian Produk Per Supplier Per Dokumen</title>
</head>
<body>
...
<header>
    ...
    <h2 style="text-align: center">** DAFTAR PEMBELIAN **<br>RINCIAN PRODUK PER SUPPLIER PER DOKUMEN</h2>
</header>
...
<main>
    ...
    <table class="table">
        ...
        <tr style="border:1px solid black;">
            ...
            <th rowspan="2" style="vertical-align: middle;">TOT.Nl AVERAGE</th>
        </tr>
        <tr>
            <th>NOMOR</th>
            <th>TANGGAL</th>
        ...
        @for($i=0;$i<count($data);$i++)
                ...
                @if($tempdoc != $data[$i]->msth_nodoc)
                    ...
                    <tr>
                        <td class="left" colspan="21"><b>Tanggal    : {{$data[$i]->msth_tgldoc}} </b></td>
                    </tr>
                @endif;
            <tr>
            ...
            @if((isset($data[$i+1]->msth_nodoc) && $tempdoc != $data[$i+1]->msth_nodoc) || !(isset($data[$i+1]->msth_nodoc)) )
                <tr style="border-bottom: 1px solid black;font-style: italic">
                    ...
                    <td class="left" colspan="7">{{ $data[$i]->msth_nodoc }} </td>
                    ...
                    <td class="right">{{ number_format($st_doc_tn,2) }}</td>
                    <td class="right" colspan="3"></td>
                    <td class="right">{{ number_format($st_doc_avg,2) }}</td>
                </tr>
                @php
                    $st_doc_gross = 0;
                    $st_doc_potongan = 0;
            ...
            @if((isset($data[$i+1]->mstd_kodesupplier) && $tempsup != $data[$i+1]->mstd_kodesupplier) || !(isset($data[$i+1]->mstd_kodesupplier)) )
                <tr style="border-bottom: 1px solid black;font-style: italic">
                    ...
                    <td class="left" colspan="7">{{ $data[$i]->mstd_kodesupplier }} - {{ $data[$i]->sup_namasupplier }}</td>
