...
@section('page_title')
    Daftar Pembelian Rincian Produk Per Supplier
@endsection
...
@section('content')
    ...
    <table class="table">
        ...
        <tr style="border-top: 1px solid black;border-bottom: 1px solid black;">
            ...
            <th colspan="2" class="tengah padding-right">-KUANTUM-</th>
            ...
            <th rowspan="2" class="tengah right padding-left">BOTOL</th>
        ...
        <tr>
            ...
            <th class="tengah right padding-right">PCS</th>
        </tr>
        </thead>
        <tbody>
        @for($i=0;$i<count($data);$i++)
                @if($tempsup != $data[$i]->mstd_kodesupplier)
                    <tr>
                        <td class="left" colspan="7"><b>SUPPLIER    : {{$data[$i]->mstd_kodesupplier}} - {{$data[$i]->sup_namasupplier}} </b></td>
                    </tr>
                @endif
            <tr>
                ...
                <td class="right padding-right">{{ number_format($data[$i]->pcs, 0, '.', ',') }}</td>
