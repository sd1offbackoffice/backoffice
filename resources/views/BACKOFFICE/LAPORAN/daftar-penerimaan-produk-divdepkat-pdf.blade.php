...
@section('content')
    <table class="table">
        ...
        <tr style="border-top: 1px solid black;border-bottom: 1px solid black;">
            <th colspan="2" class="tengah ">---NPB---</th>
            ...
            <th rowspan="2" class="tengah right">HARGA BELI</th>
            ...
            <th rowspan="2" class="tengah right">TOT NILAI AVERAGE</th>
        </tr>
        <tr>
        ...
        @for($i=0;$i<count($data);$i++)
            ...
            @if((isset($data[$i+1]->mstd_kodekategoribrg) && $tempkat != $data[$i+1]->mstd_kodekategoribrg) || !(isset($data[$i+1]->mstd_kodekategoribrg)) )
                <tr style="border-bottom: 1px solid black;">
                    ...
                    <td class="left" colspan="7">{{ $data[$i]->mstd_kodekategoribrg }} - {{ $data[$i]->kat_namakategori }}</td>
                    ...
                    <td class="right">{{ number_format($st_kat_avgcost,2) }}</td>
                </tr>
                @php
                    $skipdiv = false;
                    $st_kat_gross = 0;
            ...
            @if( isset($data[$i+1]->mstd_kodedepartement) && $tempdep != $data[$i+1]->mstd_kodedepartement || !(isset($data[$i+1]->mstd_kodedepartement)) )
                <tr style="border-bottom: 1px solid black;">
                    ...
                    <td class="left" colspan="7">{{ $data[$i]->mstd_kodedepartement }} - {{$data[$i]->dep_namadepartement}}</td>
                    ...
                    <td class="right" colspan="3"></td>
                    <td class="right">{{ number_format($st_dep_avgcost,2) }}</td>
                </tr>
                @php
                    $st_dep_gross = 0;
                    $st_dep_potongan = 0;
            ...
            @if((isset($data[$i+1]->mstd_kodedivisi) && $tempdiv != $data[$i+1]->mstd_kodedivisi) || !(isset($data[$i+1]->mstd_kodedivisi)) )
                <tr style="border-bottom: 1px solid black;">
                    ...
                    <td class="left" colspan="7">{{ $data[$i]->mstd_kodedivisi }} - {{ $data[$i]->div_namadivisi }}</td>
                    ...
                    <td class="right" colspan="3"></td>
                    <td class="right">{{ number_format($st_div_avgcost,2) }}</td>
                </tr>
                @php
                    $skipdiv = false;
                    $st_div_gross = 0;
        ...
        <tr>
            ...
            <th colspan="3"></th>
            <th class="right">{{ number_format($sum_avgcost_bkp ,2) }}</th>
        </tr>
        <tr>
            ...
            <th colspan="3"></th>
            <th class="right">{{ number_format($sum_avgcost_btkp ,2) }}</th>
        </tr>
        <tr>
            ...
            <th colspan="3"></th>
            <th class="right">{{ number_format($sum_avgcost_bkp+$sum_avgcost_btkp ,2) }}</th>
        </tr>
        </tbody>
    </table>
    @endsection
