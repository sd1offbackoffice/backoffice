...
@section('title','LAPORAN | DAFTAR PEMUSNAHAN BARANG')
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <select class="form-control" id="tipe">
                                        <option value="1">1. DAFTAR PEMUSNAHAN RINGKASAN DIVISI/DEPARTEMEN/KATEGORI
                                        </option>
                                        <option value="2">2. DAFTAR PEMUSNAHAN REKAP PRODUK PER DIVISI/DEPARTEMEN/KATEGORI
                                        </option>
                                        <option value="3">3. DAFTAR PEMUSNAHAN RINCIAN PRODUK PER
                                            SUPPLIER
                                        </option>
                                    </select>
                                </div>
