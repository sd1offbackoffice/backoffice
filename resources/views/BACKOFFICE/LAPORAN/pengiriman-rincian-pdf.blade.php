...
<main>
    <table class="table">
        ...
        <tr>
            ...
            <th width="5%" class="tengah" rowspan="2">BONUS</th>
            <th width="5%" class="tengah" rowspan="2">GROSS</th>
            <th width="5%" class="tengah" rowspan="2">POTONGAN</th>
            ...
            <th width="5%" class="tengah" rowspan="2">TOTAL NILAI</th>
        ...
        @for($i=0;$i<count($data);$i++)
            ...
            @if($tempdiv != $d->mstd_kodedivisi)
                ...
                <tr>
                    ...
                    <td class="left" colspan="16"><strong> - {{ $d->div_namadivisi }}</strong></td>
                </tr>
            @endif
            @php
            $grossdiv += $d->gross;
            ...
            <tr>
                ...
                <td class="right">{{ number_format($d->potongan,2) }}</td>
