    ...
    <table class="table table-bordered table-responsive" style="border-collapse: collapse">
        <thead style="border-top: 2px solid black;border-bottom: 2px solid black;">
            <tr>
                ...
                <th style="vertical-align: middle; text-align: left">TGL PRPANJANGN&nbsp;&nbsp;&nbsp;&nbsp;</th>
                <th style="vertical-align: middle; text-align: left">USER&nbsp;&nbsp;&nbsp;&nbsp;</th>
                <th style="vertical-align: middle; text-align: left">TANGGAL&nbsp;&nbsp;&nbsp;&nbsp;</th>
                <th style="vertical-align: middle; text-align: left">JAM&nbsp;&nbsp;&nbsp;&nbsp;</th>
            </tr>
        </thead>
        ...
        @for($i=0;$i<sizeof($data);$i++)
            ...
            <tr>
                ...
                <td style="text-align: left">{{$data[$i]->cus_create_by}}&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td style="text-align: left">{{$data[$i]->tglupd}}&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td style="text-align: left">{{$data[$i]->jamupd}}&nbsp;&nbsp;&nbsp;&nbsp;</td>
            </tr>
            @php
