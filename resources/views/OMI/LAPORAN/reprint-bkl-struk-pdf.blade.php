...
@else
    ...
    <div style="float: left">{{$result[0]->tanggal}} <span style="margin-left: 17%">**Re-Print**</span></div>
    ...
    <main>
        ...
        <table width="100%">
            ...
            <tr>
                <td colspan="4" style="text-align: center"><h3>*** Terima Kasih *** <br>UNTUK BARANG KENA PAJAK <br>HARGA SUDAH TERMASUK PPN <span><p>**Re-Print**</p></span></h3></td>
            </tr>
            <tr>
                <td>NO MEMBER</td>
