...
<header>
    ...
    <table class="table table-bordered table-responsive" style="border-collapse: collapse">
        ...
        @for($i=0;$i<sizeof($datas);$i++)
            ...
            $createDate = new DateTime($datas[$i]->jh_referencedate);
            ...
            <tr>
                ...
                <td style="text-align: left">{{$datas[$i]->jh_referencecashierid}}</td>
                <td style="text-align: center;">{{$datas[$i]->jh_referenceno}}</td>
            </tr>
