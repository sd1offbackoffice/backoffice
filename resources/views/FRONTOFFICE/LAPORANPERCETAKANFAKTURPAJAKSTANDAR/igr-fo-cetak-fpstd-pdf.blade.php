...
<head>
    <title>LAPORAN PENCETAKAN FAKTUR PAJAK STANDAR</title>
...
<header>
    ...
    <div style="float:center;">
        <p style="font-weight:bold;font-size:14px;text-align: center;margin: 0;padding: 0">LAPORAN PENCETAKAN FAKTUR PAJAK STANDAR</p>
