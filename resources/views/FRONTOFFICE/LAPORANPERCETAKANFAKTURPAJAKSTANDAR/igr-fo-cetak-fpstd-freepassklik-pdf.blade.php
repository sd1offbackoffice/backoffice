...
<head>
    <title>LAPORAN PENCETAKAN FAKTUR PAJAK STANDAR FREEPASS KLIK IGR </title>
...
<header>
    ...
    <div style="float:center;">
        ...
        <p style="font-weight:bold;font-size:14px;text-align: center;margin: 0;padding: 0">FAKTUR PAJAK STANDAR FREEPASS KLIK IGR</p>
