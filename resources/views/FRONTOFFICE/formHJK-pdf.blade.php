    ...
    <table class="table table-bordered table-responsive" style="border-collapse: collapse">
        <thead style="border-top: 3px solid black;border-bottom: 3px solid black;">
            <tr style="text-align: center; vertical-align: center">
                ...
                <th rowspan="3" width="150px" style="text-align: left; vertical-align: middle; border-right: 1px solid black">DESKRIPSI</th>
        ...
        @for($i=1;$i<sizeof($datas);$i++)
            <tr style="text-align: center; vertical-align: center">
                ...
                <td>{{$datas[$i]['lcost']}}</td>
                <td>{{$datas[$i]['avgcost']}}</td>
                <td>{{$datas[$i]['normal']}}</td>
                <td>{{$datas[$i]['usulan']}}</td>
                <td>{{$datas[$i]['normalmargin']}}</td>
                <td>{{$datas[$i]['lcostmargin']}}</td>
                <td>{{$datas[$i]['avgcostmargin']}}</td>
            </tr>
        @endfor
        </tbody>
    </table>
