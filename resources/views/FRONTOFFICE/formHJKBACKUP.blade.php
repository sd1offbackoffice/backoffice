                            ...
                            <div class="col">
                                <div class="tableFixedHeader">
                                    <table class="table table-sm">
                                        <thead>
                                        <tr>
                                            <th id="modalThName2">Plu</th>
                                            <th id="modalThName1">Deskripsi</th>
                                            <th id="modalThName3">Satuan</th>
                                            <th id="modalThName2">Hargajual</th>
                                        </tr>
                                        </thead>
        ...
        function getPlu(no, val) {
            ...
            if (tempPlu == null){
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        for (i = 0; i< result.length; i++){
                            $('#tbodyModalHelp').append("<tr onclick=choosePlu('"+ result[i].prd_prdcd +"','"+ index +"') class='modalRow'><td>"+ result[i].prd_prdcd +"</td> <td>"+ result[i].prd_deskripsipanjang +"</td> <td>"+ result[i].satuan +"</td><td>"+ result[i].prd_hrgjual +"</td></tr>")
                        }
                        $('#idRow').val(index);
                ...
                for (i = 0; i< tempPlu.length; i++){
                    $('#tbodyModalHelp').append("<tr onclick=choosePlu('"+ tempPlu[i].prd_prdcd +"','"+ index +"') class='modalRow'><td>"+ tempPlu[i].prd_deskripsipanjang +"</td> <td>"+ tempPlu[i].prd_prdcd +"</td> <td>"+ tempPlu[i].satuan +"</td><td>"+ tempPlu[i].prd_hrgjual +"</td></tr>")
                }
